...
$banners = DB::table('promotion_banners')->orderBy('serial_num', 'asc')->limit(3)->get();
                           ...
                           <div id="indProduct">
                            <div class="product-imgbox" >
                                ...
                                <div class="product-icon icon-inline">
                                    ...
                                    <button class="tooltip-top add-cartnoty" onclick="Add_to_wishlist('{{$new_arrival->id}}')" data-tippy-content="Wishlist">
                            ...
                            <div class="product-imgbox" >
                                ...
                                <div class="product-icon icon-inline">
                                    @if($special_offer->stock > 0)
                                       ...
                                       <button class="tooltip-top  add-cartnoty" onclick="add_to_cart('{{$special_offer->id}}', 1)" data-tippy-content="Add to cart">
                                          <i data-feather="shopping-cart"></i>
                                       </button>
                                       @else
                                    ...
                                    <button class="tooltip-top add-cartnoty" onclick="Add_to_wishlist('{{$special_offer->id}}')" data-tippy-content="Wishlist">
                                        <i class="far fa-heart"></i>
                                    </button>
