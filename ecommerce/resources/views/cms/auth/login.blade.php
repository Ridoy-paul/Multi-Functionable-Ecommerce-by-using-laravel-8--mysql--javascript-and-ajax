                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1"><b>Admin Sign-in</b></h4>
                                <p class="card-text mb-2 text-danger text-center text-bold">{{ session('error') }}</p>
                                <form class="auth-login-form mt-2" action="{{ route('admin.login') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="login-email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Ex: cse.ridoypaul@gmail.com" aria-describedby="login-email" tabindex="1" autofocus required/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" id="password" name="password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" required aria-describedby="login-password" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pin" name="pin" placeholder="2426" maxlength="4" tabindex="1" autofocus  required/>
                                    </div>
