                                    ...
                                    <tr class="cartpage" id="cartTr{{$data['secPID']}}">
                                        ...
                                        <td class="cart-product-quantity">
                                            <input type="number" onkeyup="changeCartQty({{ $data['secPID'] }})"
                                                onchange="changeCartQty({{ $data['secPID'] }})"
                                                id="cartQty{{ $data['secPID'] }}"
                                                class="qty-input form-control inputTypeNumberQ"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 col-5">
                                            ...
                                            <select id="shippingAreaChange" onchange="ShippingCng()" name="shippingCharge" class="form-select">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-6">
                                            <div class="cart-checkout-btn text-center">
                                                <button type="submit" class="btn btn-success btn-block checkout-btn">CHECKOUT</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
